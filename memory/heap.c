...
void test_heap()
{
	...
	void *addr1 = kmalloc(80);
	printk("kmalloc    80 byte in 0x%X\n", addr1);
	void *addr2 = kmalloc(800);
	printk("kmalloc   800 byte in 0x%X\n", addr2);
	void *addr3 = kmalloc(8000);
	printk("kmalloc  8000 byte in 0x%X\n", addr3);
	void *addr4 = kmalloc(80000);
	printk("kmalloc 80000 byte in 0x%X\n\n", addr4);
